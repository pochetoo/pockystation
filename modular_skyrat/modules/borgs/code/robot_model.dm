...
/obj/item/robot_model/service
	...
	borg_skins = list(
		...
		"Meka (Dapper)" = list(SKIN_ICON_STATE = "mekaserve_alt2", SKIN_LIGHT_KEY = "mekaserve_alt2", SKIN_ICON = CYBORG_ICON_SERVICE_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUETIP, TRAIT_R_TALL), TALL_HAT_OFFSET),
